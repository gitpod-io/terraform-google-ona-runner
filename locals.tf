locals {
  ...
  # Default images
  default_runner_image = "us-docker.pkg.dev/gitpod-next-production/gitpod-next/gitpod-gcp-runner:20260907.1094"
  default_proxy_image  = "us-docker.pkg.dev/gitpod-next-production/gitpod-next/gitpod-proxy:20260907.1094"
  ...
  docker_config_object_name = local.docker_config_enabled ? google_storage_bucket_object.docker_config_private[0].name : ""
